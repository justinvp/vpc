...
namespace Pulumi.Vpc
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Vpc.version.txt");
    ...
    internal sealed class VpcResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public VpcResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
